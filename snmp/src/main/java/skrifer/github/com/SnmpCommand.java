...
public enum SnmpCommand {
    ...
    //科达KDV8000A
    KedaKDV8000ASystemTime("1.3.6.1.4.1.8888.1.1.1.1.2.0", "科达kdv8000a系统时间", "get"),
    KedaKDV8000ASystemDesc("1.3.6.1.2.1.1.1.0", "科达kdv8000a系统描述", "bulk"),
    ...
    private String type;
    SnmpCommand(String oid, String describe, String type) {
        this.oid = oid;
