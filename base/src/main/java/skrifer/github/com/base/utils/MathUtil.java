...
/**
 * * @title 数学计算工具类* @description 提供常用的数值加减乘除计算 , 及多个数值的求和 , 平均值 , 最大最小值计算
 */
public class MathUtil {
    ...
    /*** 精确加法运算* @param v1 被加数* @param v2 加数* @return 两个参数的和(BigDecimal)*/
    ...
    /*** 精确减法运算* @param v1 被减数* @param v2 减数* @return 两个参数的差(BigDecimal)*/
    ...
    /*** 精确乘法运算* @param v1 被乘数* @param v2 乘数* @return 两个参数的积(BigDecimal)*/
    ...
    /*** ( 相对 )精确除法运算 , 当发生除不尽情况时 , 精确到 小数点以后2位 , 以后数字四舍五入* @param v1 被除数* @param v2 除数* @return 两个参数的商(BigDecimal)*/

    public static BigDecimal divide(BigDecimal v1, BigDecimal v2) {
        return v1.divide(v2, DEF_DIV_SCALE, BigDecimal.ROUND_HALF_UP);
    }

    /*** ( 相对 )精确除法运算 . 当发生除不尽情况时 , 由scale参数指 定精度 , 以后数字四舍五入* @param v1 被除数* @param v2 除数* @param scale 表示表示需要精确到小数点以后几位* @return 两个参数的商(BigDecimal)*/
    ...
    /*** 精确加法运算* @param v1 被加数* @param v2 加数* @return 两个参数的和(String)*/
    ...
    /*** 精确减法运算* @param v1 被减数* @param v2 减数* @return 两个参数的差(String)*/
    ...
    /*** 精确乘法运算* @param v1 被乘数* @param v2 乘数* @return 两个参数的积(String)*/
    ...
    /*** ( 相对 )精确除法运算 , 当发生除不尽情况时 , 精确到 小数点以后2位 , 以后数字四舍五入* @param v1 被除数* @param v2 除数* @return 两个参数的商(String)*/

    public static String divide(String v1, String v2) {
        return divide(v1, v2, DEF_DIV_SCALE);
    }

    /*** ( 相对 )精确除法运算 . 当发生除不尽情况时 , 由scale参数指 定精度 , 以后数字四舍五入* @param v1 被除数* @param v2 除数* @param scale 表示表示需要精确到小数点以后几位* @return 两个参数的商(String)*/
    ...
    /*** 精确加法运算 , 计算多个数值总和 , 若其中有null值则忽略* @param valList 被加数集合* @return 两个参数的和(BigDecimal)*/
    ...
    /*** 精确加法运算 , 计算多个数值总和 , 若其中有null值则忽略* @param valList 被加数集合* @return 两个参数的和(String)*/
    ...
    /*** 最大值* @param v1* @param valList* @return*/
    ...
    /*** 最小值* @param v1* @param valList* @return*/
    ...
    /*** 判断字符串是否为空(不依赖第三方)* @param str* @return*/
